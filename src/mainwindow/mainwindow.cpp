...
#ifdef Q_OS_MAC
	: SARibbonMainWindow(parent, SARibbonMainWindowStyleFlag::UseRibbonMenuBar | SARibbonMainWindowStyleFlag::UseNativeFrame),
#else
...
void MainWindow::initToolbar()
{
	...
	if constexpr (true) {
#ifdef Q_OS_MAC
		// macOS下不显示Quick Access Bar，因为没有合适的地方放
#else
		//撤销重做
...
#ifdef Q_OS_MAC
		// macOS下actGlobalConfig未定义，因为Quick Access Bar被隐藏
#else
